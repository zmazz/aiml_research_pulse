...
st.markdown("<h3 style='text-align: center; color: #a2ff7e'>ﮩ٨ـﮩﮩ٨ـ   Rᴇsᴇᴀʀcʜ Puʟsᴇ   ﮩ٨ـﮩﮩ٨ـ</h3>", unsafe_allow_html=True)
...
with About:
    ...
    st.markdown(' ')
    st.markdown("<h6 style='text-align: center; color: #a2ff7e'>--- Search engine ---</h6>", unsafe_allow_html=True)
    ...
    st.markdown(' ')
    st.markdown("<h6 style='text-align: center; color: #a2ff7e'>--- Research papers & authors ---</h6>", unsafe_allow_html=True)
    ...
    st.markdown(' ')
    st.markdown("<h6 style='text-align: center; color: #a2ff7e'>--- Analytics dashboard ---</h6>", unsafe_allow_html=True)
    ...
    st.markdown(' ')
    st.markdown("<h6 style='text-align: center; color: #a2ff7e'>--- NLP-based tools ---</h6>", unsafe_allow_html=True)
