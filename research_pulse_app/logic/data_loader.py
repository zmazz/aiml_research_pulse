...
def data_loader():
    ...
    # OR THIS
    #data=pd.read_csv("../../datasets/AI_ML_ArXiv_Papers.csv",low_memory=False)
    ...
    df_citations = pd.read_csv("../../datasets/arxiv-metadata-ext-citation.csv",dtype={"id":object,"id_reference":object})
